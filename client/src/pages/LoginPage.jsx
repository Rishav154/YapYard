...
const LoginPage = () => {
    // --- State and Context hooks (unchanged) ---
    ...
    // --- Handlers and Functions (unchanged) ---
    ...
    return (
        <>
            ...
            <div className="bg-[url('/bgImage.png')] bg-cover bg-center min-h-screen flex flex-col items-center justify-center p-4">
                ...
                <img src={assets.logo} alt="Logo" className='h-12 w-auto mb-6 sm:mb-8' />
                
                {/* The main login/signup card */}
                <div className="w-full max-w-md bg-white/20 backdrop-blur-xl rounded-2xl shadow-2xl p-6 sm:p-8 space-y-4 sm:space-y-6 border border-white/30">
                    
                    {/* Heading with responsive text size */}
                    <h2 className='text-center text-2xl sm:text-3xl font-bold text-slate-700 tracking-tight'>{currState}</h2>

                    {/* The form with responsive vertical spacing */}
